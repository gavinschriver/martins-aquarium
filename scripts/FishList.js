/* this is where the action happens; this file takes DATA from the array coming from FishDataProvider and smooshes it into the FUNCTION 
 ...
 import {makeAnHTMLFish} from "./fishFactory.js" // b) bring in the function to smoosh out individual HTML fish from fish objects in the array above
 ...
 export const listOfFish = () => {  // create an exportable function called listOfFish that will...
    ...
    for (const currentFishObj of fishArrayCopy) { // take each fish object from that copied fish array...
